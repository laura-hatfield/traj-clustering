...
par(mfrow=c(2,3))
plot(seq(0,1,length=400),colMeans(foo4[clust$clustering == 1,-1]),type='l',main=paste('Cluster 1:',round(P[1],2)),ylab='Proportion',xlab='',xaxt='n')
...
plot(seq(0,1,length=400),colMeans(foo4[clust$clustering == 2,-1]),type='l',main=paste('Cluster 2:',round(P[2],2)),ylab='Proportion',xlab='',xaxt='n')
abline(v=seq(.25,.75,by=.25),col='black',lwd=1)
axis(1,at=seq(0,.95,by=0.0625),label=rep(c(0,0.25,0.5,0.75),4))
mtext(c('None','Hospital','Hospice','SNF'),3,line=.75,at=seq(.12,.88,by=.25),cex=.8)


plot(seq(0,1,length=400),colMeans(foo4[clust$clustering == 3,-1]),type='l',main=paste('Cluster 3:',round(P[3],2)),ylab='Proportion',xlab='',xaxt='n')
abline(v=seq(.25,.75,by=.25),col='black',lwd=1)
axis(1,at=seq(0,.95,by=0.0625),label=rep(c(0,0.25,0.5,0.75),4))
mtext(c('None','Hospital','Hospice','SNF'),3,line=.75,at=seq(.12,.88,by=.25),cex=.8)


plot(seq(0,1,length=400),colMeans(foo4[clust$clustering == 4,-1]),type='l',main=paste('Cluster 4:',round(P[4],2)),ylab='Proportion',xlab='',xaxt='n')
abline(v=seq(.25,.75,by=.25),col='black',lwd=1)
axis(1,at=seq(0,.95,by=0.0625),label=rep(c(0,0.25,0.5,0.75),4))
mtext(c('None','Hospital','Hospice','SNF'),3,line=.75,at=seq(.12,.88,by=.25),cex=.8)


plot(seq(0,1,length=400),colMeans(foo4[clust$clustering == 5,-1]),type='l',main=paste('Cluster 4:',round(P[4],2)),ylab='Proportion',xlab='',xaxt='n')
abline(v=seq(.25,.75,by=.25),col='black',lwd=1)
axis(1,at=seq(0,.95,by=0.0625),label=rep(c(0,0.25,0.5,0.75),4))
mtext(c('None','Hospital','Hospice','SNF'),3,line=.75,at=seq(.12,.88,by=.25),cex=.8)
